	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="main_locbg font2"><img
				...
				&gt; 用户查询&nbsp;&nbsp;&nbsp;当前用户权限：【${sessionScope.user_session.status}】<span style="color: red;">${mess }</span></td>
			<td width="15" height="32"><img
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td class="font3">登录名：<input type="text" name="loginname"
											value="${requestScope.user.loginname}" />&nbsp;&nbsp;用户名：<input
											...
											<%-- <input type="text" name="status" value="${user.status}"> --%><input
											type="button" value="查询" id="query" /><input type="button"
											value="删除" id="delete" /><span style="color: red;">${mess }</span>
										</td>
									</tr>
								</table>
							</td>
						...
						<c:forEach items="${pageModel.list}" var="user"
							...
							<tr id="data_${stat.index}" align="center" class="main_trbg"
								...
								<td align="center" width="40px;"><a
									href="${ctx}/userupdate.action?id=${user.id}&delstate=${sessionScope.user_session.status}"> <%-- ?id=${user.id} --%><img
